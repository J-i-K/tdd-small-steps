...
function createApp(database) {
  ...
  function dateToTemporalPlainDate ( date ) { console.log(date.getFullYear()) }//return Temporal.PlainDate.from({ year: date.getFullYear(), month: date.getMonth(), day: date.getDay})}
