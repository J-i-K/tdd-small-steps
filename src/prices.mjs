...
function createApp(database) {
  ...
  function dateToTemporalPlainDate ( date ) { console.log(date) }//return Temporal.PlainDate.from({ year: date.getFullYear(), month: date.getMonth(), day: date.getDay})}

  function parseDate(dateString) {
    if (dateString) {
      dateToTemporalPlainDate(new Date(dateString).getFullYear)
